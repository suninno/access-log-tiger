...
/**
 * <p>Client Time의 시간별 평균 지연 DTO</p>
 * Reference Object의 키값은 hh_service이다.
 * @author suninno.kim
 * @date 2014. 4. 15.
 */
@XmlRootElement
public class AvgClienttimeHourlyDto {
    ...
    public AvgClienttimeHourlyDto(String hh, String service) {
        this.hh = hh;
    ...
    public void setMCA(AvgClienttimeHourlyVO vo){
    ...
    public void setMCC(AvgClienttimeHourlyVO vo){
    ...
    public void setOthers(AvgClienttimeHourlyVO vo){
    ...
    public static final String getCSVHeader() {
        return "시간대,서비스,MC A' rs 평균지연,MC A' re 평균지연,MC A' lee 평균지연,MC C' rs 평균지연, MC C' re 평균지연,MC C' lee 평균지연,Others' rs 평균지연, Others' re 평균지연,Others' lee 평균지연";
    }
    ...
    public String getCSVValue() {
        ...
        return hh + "," + service + "," + mcaRs + "," + mcaRe + "," + mcaLee +
                "," + mccRs + "," + mccRe + "," + mccLee +
